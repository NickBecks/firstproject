...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name ="greetNicely", path = "greetNicely", httpMethod = HttpMethod.GET)
    public HelloClass greetNicely(@Named("name") String name, @Named("period") String period, @Named("niceWords") String niceWords){
    return new HelloClass(name,period,niceWords);
    }
